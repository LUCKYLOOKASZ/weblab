    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(1990, 1, 1), 0, new DateTime(2024, 11, 19, 17, 29, 45, 741, DateTimeKind.Local).AddTicks(7853), "", "Jan", 101, "123 456 789", "Kowalski" },
                    { 2, new DateOnly(1995, 5, 5), 0, new DateTime(2024, 11, 19, 17, 29, 45, 741, DateTimeKind.Local).AddTicks(7897), "", "Anna", 101, "987 654 321", "Nowak" },
                    { 3, new DateOnly(2000, 10, 10), 0, new DateTime(2024, 11, 19, 17, 29, 45, 741, DateTimeKind.Local).AddTicks(7900), "", "Piotr", 102, "456 789 123", "Wiśniewski" }
                });
